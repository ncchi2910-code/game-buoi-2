...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100%", background: C.cream, fontFamily: "'Be Vietnam Pro', sans-serif", color: C.ink }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,500;0,600;0,700;1,500&family=Be+Vietnam+Pro:wght@300;400;500;600;700&display=swap');
      ...
      <div style={{ maxWidth: 920, margin: "0 auto", padding: "28px 20px 64px" }}>
        ...
        {phase === "intro" && (
          <div className="rise">
            ...
            <h1 className="serif" style={{ fontSize: 40, lineHeight: 1.12, margin: "16px 0 10px", color: C.forest }}>
...
function Summary({ P, reset }) {
  ...
  return (
    <div className="rise">
      ...
      <h1 className="serif" style={{ fontSize: 34, color: C.forest, margin: "14px 0 6px" }}>Bạn đã đưa GreenBox qua trọn 12 tháng</h1>

      {/* Câu chốt tương phản */}
      <div style={{ background: C.forest, color: "#fff", borderRadius: 16, padding: "18px 20px", margin: "16px 0 22px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        <div>
